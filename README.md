...
Сакцентирую на том, что видете, Я ЭТО ВСЕ НЕ ЗАПОМИНАЮ. Я вот точно так же открываю доку и прям по пунктам иду.\
Потому что запоминать это абсолютно смысла нет.
